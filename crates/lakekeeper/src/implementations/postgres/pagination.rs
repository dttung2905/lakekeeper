...
mod test {
    ...
    fn test_paginate_token_edge_cases_valid() {
        ...
        // Test with very large timestamp (but valid)
    ...
    fn test_paginate_token_malformed_structure() {
        // Helper function to create base64 from string
    ...
    fn test_paginate_token_invalid_timestamp() {
        ...
        for invalid in invalid_timestamp_cases {
            ...
            let error = result.unwrap_err();
            // Could be either parse error or timestamp error
            assert!(
    ...
    fn test_paginate_token_invalid_id_parsing() {
        ...
        // Test with numeric ID type but non-numeric string
        ...
        // Test with UUID type but invalid UUID string
